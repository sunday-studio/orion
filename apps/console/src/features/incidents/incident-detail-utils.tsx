...
import type { ApiAlertDeliveryResponse, ApiIncidentNextActionResponse, ApiIncidentResponse, ApiIncidentTimelineItemResponse, ApiMonitorReportResponse } from "@/orion-sdk";
import type { ColumnDef } from "@tanstack/react-table";
import { BellRingIcon, CheckIcon, CircleCheckIcon, RotateCcwIcon, ShieldCheckIcon, WrenchIcon } from "lucide-react";
...
export type IncidentComponentImpact = NonNullable<ApiIncidentResponse["impacted_components"]>[number];
...
export const nextActionHref = (action: ApiIncidentNextActionResponse, incident: ApiIncidentResponse) => {
